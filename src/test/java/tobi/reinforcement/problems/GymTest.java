...
//      05/03/2020 14:25
        String json3 = "{\"outputs\":4,\"constValues\":{},\"neuronInputs\":{\"IN#10\":[],\"IN#11\":[],\"IN#12\":[],\"OUT#0\":[{\"strength\":1.7796484971475381,\"neuron\":\"IN#5\"}],\"OUT#2\":[{\"strength\":0.6875170455163666,\"neuron\":\"IN#0\"}],\"OUT#1\":[{\"strength\":1.3287986254742692,\"neuron\":\"IN#8\"}],\"OUT#3\":[{\"strength\":1.0649573042047338,\"neuron\":\"IN#a\"}],\"IN#a\":[],\"IN#d\":[],\"IN#e\":[],\"IN#b\":[],\"IN#c\":[],\"IN#13\":[],\"IN#14\":[],\"IN#f\":[],\"IN#15\":[],\"IN#16\":[],\"IN#17\":[],\"IN#0\":[],\"IN#1\":[],\"IN#4\":[],\"IN#5\":[],\"IN#2\":[],\"IN#3\":[],\"IN#8\":[],\"IN#9\":[],\"IN#6\":[],\"IN#7\":[]},\"varOutputs\":{\"IN#10\":[],\"IN#11\":[],\"IN#12\":[],\"OUT#0\":[\"IN#10\",\"IN#5\",\"IN#14\",\"IN#d\"],\"OUT#2\":[\"IN#10\",\"IN#16\",\"IN#15\",\"IN#4\",\"IN#b\",\"IN#9\",\"IN#0\",\"IN#2\",\"IN#13\",\"IN#d\",\"IN#6\"],\"OUT#1\":[\"IN#10\",\"IN#b\",\"IN#9\",\"IN#7\",\"IN#14\",\"IN#12\",\"IN#3\",\"IN#6\"],\"OUT#3\":[\"IN#10\",\"IN#8\",\"IN#15\",\"IN#b\",\"IN#0\",\"IN#f\",\"IN#3\",\"IN#17\",\"IN#c\",\"IN#6\"],\"IN#a\":[],\"IN#d\":[],\"IN#e\":[],\"IN#b\":[],\"IN#c\":[],\"IN#13\":[],\"IN#14\":[],\"IN#f\":[],\"IN#15\":[],\"IN#16\":[],\"IN#17\":[],\"IN#0\":[],\"IN#1\":[],\"IN#4\":[],\"IN#5\":[],\"IN#2\":[],\"IN#3\":[],\"IN#8\":[],\"IN#9\":[],\"IN#6\":[],\"IN#7\":[]},\"inputs\":24}";
        try (BoxBoxGym gym = new BoxBoxGym("BipedalWalker-v3")) {
//            gym.test(Network.parse(json), true, 0);
//            gym.test(Network.parse(json2), true, 0);
            gym.test(Network.parse(json3), true, 0);
        }
    }
