...
//        String json = "{\"outputs\":2,\"constValues\":{},\"neuronInputs\":{\"IN#0\":[],\"IN#1\":[],\"ADD#64a896b0\":[\"IN#3\",\"IN#2\"],\"IN#2\":[],\"IN#3\":[],\"DIVIDE#219f4597\":[\"ADD#64a896b0\",\"IN#2\"],\"OUT#0\":[\"OUT#1\"],\"OUT#1\":[\"DIVIDE#219f4597\"]},\"varOutputs\":{\"IN#0\":[],\"IN#1\":[],\"ADD#64a896b0\":[\"IN#3\"],\"IN#2\":[],\"IN#3\":[],\"DIVIDE#219f4597\":[],\"OUT#0\":[],\"OUT#1\":[\"IN#3\"]},\"inputs\":4}\n";
        String json = "{\"outputs\":2,\"constValues\":{},\"neuronInputs\":{\"IN#0\":[],\"IN#1\":[],\"ADD#1a6c1270\":[{\"strength\":0.8544669835165402,\"neuron\":\"IN#2\"},{\"strength\":0.0546185946838087,\"neuron\":\"IN#0\"}],\"IN#2\":[],\"IN#3\":[],\"OUT#0\":[{\"strength\":0.4901690616322598,\"neuron\":\"SUBTRACT#44d52de2\"}],\"SUBTRACT#44d52de2\":[{\"strength\":0.5235067290165814,\"neuron\":\"IN#0\"},{\"strength\":0.9447557897593497,\"neuron\":\"ADD#1a6c1270\"}],\"OUT#1\":[{\"strength\":1.7268047244791136,\"neuron\":\"IN#3\"}]},\"varOutputs\":{\"IN#0\":[],\"IN#1\":[],\"ADD#1a6c1270\":[],\"IN#2\":[],\"IN#3\":[],\"OUT#0\":[],\"SUBTRACT#44d52de2\":[],\"OUT#1\":[]},\"inputs\":4}";
